...
@pad 2008-04-10  Assets:Checking  Equity:Opening-Balances
2008-04-15 * Misc
  Assets:Checking             10.00 USD
  Equity:Opening-Balances
@check 2008-04-20  Assets:Checking  1203.23 USD
        """, 'before')
        ...
        lgr = ledger_str(self.def_accounts + """
@check 2008-04-20  Assets:Checking  43.00 USD
@pad 2008-04-22  Assets:Checking  Equity:Opening-Balances
2008-04-23 * Misc
  Assets:Checking             10.00 USD
  Equity:Opening-Balances
@check 2008-04-25  Assets:Checking  64.00 USD
""", 'between1')
        assert len(lgr.transactions) == 2
        txn = filter(lambda x: x.flag == 'A', lgr.transactions)[0]
        ...
        lgr = ledger_str(self.def_accounts + """
@check 2008-04-20  Assets:Checking  21.00 USD
2008-04-21 * Misc
  Assets:Checking             10.00 USD
  Equity:Opening-Balances
@pad 2008-04-22  Assets:Checking  Equity:Opening-Balances
2008-04-23 * Misc
  Assets:Checking             10.00 USD
  Equity:Opening-Balances
@check 2008-04-24  Assets:Checking  53.01 USD
""", 'between2')
...
2008-04-23 * Misc
  ...
  Equity:Opening-Balances
@pad 2008-04-22  Assets:Checking  Equity:Opening-Balances
@check 2008-04-25  Assets:Checking  64.02 USD
""", 'between3')
        assert len(lgr.transactions) == 2
        txn = filter(lambda x: x.flag == 'A', lgr.transactions)[0]
        assert txn.actual_date == date(2008, 4, 22)
        ...
        lgr = ledger_str(self.def_accounts + """
2008-01-01 * Misc
  Assets:Checking             17.00 USD
  Equity:Opening-Balances
@check 2008-04-20  Assets:Checking  17.00 USD
@pad 2008-04-21  Assets:Checking  Equity:Opening-Balances
""", 'after')
...
2008-04-23 * Misc
  Assets:Checking             10.00 USD
  Equity:Opening-Balances
@check 2008-04-25  Assets:Checking  53.00 USD
""", 'empty1')
        assert len(lgr.transactions) == 2
        assert not filter(lambda x: x.flag == 'A', lgr.transactions)

        lgr = ledger_str(self.def_accounts + """
@pad 2008-04-12  Assets:Checking  Equity:Opening-Balances
@check 2008-04-20  Assets:Checking  0.00 USD
""", 'empty2')
