...
class TestLexer(unittest.TestCase):
    ...
    def test_lex_iter(self, tokens, errors):
        ...
        self.assertEqual([
            ...
            ('DATE', 1, '2014/01/02', datetime.date(2014, 1, 2)),
            ('EOL', 2, '\n', None),
            ('TIME', 2, '14:02:59', datetime.time(14, 2, 59)),
            ('EOL', 3, '\n', None),
            ('ACCOUNT', 3, 'Assets:US:Bank:Checking', 'Assets:US:Bank:Checking'),
            ('EOL', 4, '\n', None),
            ('ACCOUNT', 4, 'Liabilities:US:Bank:Credit', 'Liabilities:US:Bank:Credit'),
            ('EOL', 5, '\n', None),
            ('ACCOUNT', 5, 'Other:Bank', 'Other:Bank'),
            ('EOL', 6, '\n', None),
            ('CURRENCY', 6, 'USD', 'USD'),
            ('CURRENCY', 6, 'HOOL', 'HOOL'),
            ('CURRENCY', 6, 'TEST_D', 'TEST_D'),
            ('CURRENCY', 6, 'TEST_3', 'TEST_3'),
            ('CURRENCY', 6, 'TEST-D', 'TEST-D'),
            ('CURRENCY', 6, 'TEST-3', 'TEST-3'),
            ('CURRENCY', 6, 'NT', 'NT'),
            ('EOL', 7, '\n', None),
            ('STRING', 7, '"', 'Nice dinner at Mermaid Inn'),
            ('EOL', 8, '\n', None),
            ('STRING', 8, '"', ''),
            ('EOL', 9, '\n', None),
            ('NUMBER', 9, '123', D('123')),
            ('NUMBER', 9, '123.45', D('123.45')),
            ('NUMBER', 9, '123.456789', D('123.456789')),
            ('MINUS', 9, '-', None),
            ('NUMBER', 9, '123', D('123')),
            ('MINUS', 9, '-', None),
            ('NUMBER', 9, '123.456789', D('123.456789')),
            ('EOL', 10, '\n', None),
            ('TAG', 10, '#sometag123', 'sometag123'),
            ('EOL', 11, '\n', None),
            ('LINK', 11, '^sometag123', 'sometag123'),
            ('EOL', 12, '\n', None),
            ('KEY', 12, 'somekey:', 'somekey'),
            ('COLON', 12, ':', None),
            ('EOL', 13, '\n', None),
            ('EOL', 13, '\x00', None)
            ], tokens)
