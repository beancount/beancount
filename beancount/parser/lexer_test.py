...
class TestLexer(unittest.TestCase):
    ...
    def test_date_followed_by_number(self, tokens, errors):
        ...
        """
        self.assertEqual([
            ('LEX_ERROR', 1, b'2013-12-228', None),
            ('EOL', 2, b'\n', None),
            ('EOL', 2, b'\x00', None),
            ], tokens)
    ...
    def test_account_names_with_numbers(self, tokens, errors):
        ...
        self.assertEqual([
            ...
            ('EOL', 3, b'\n', None),
            ('LEX_ERROR', 3, b'Assets:signals', None),
            ('EOL', 4, b'\n', None),
            ('EOL', 4, b'\x00', None)
        ], tokens)
