...
def assertEqualEntries(expected_entries, actual_entries, failfunc=DEFAULT_FAILFUNC):
...
def assertIncludesEntries(subset_entries, entries, failfunc=DEFAULT_FAILFUNC):
...
def assertExcludesEntries(subset_entries, entries, failfunc=DEFAULT_FAILFUNC):
