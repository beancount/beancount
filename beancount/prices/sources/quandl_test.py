...
class QuandlPriceFetcher(unittest.TestCase):
    def test_parse_ticker(self):
        ...
        self.assertEqual(
            quandl.TickerSpec("WIKI", "FB", None), quandl.parse_ticker("WIKI:FB")
        )
        self.assertEqual(
            quandl.TickerSpec("LBMA", "GOLD", "USD (PM)"),
    ...
    def test_error_premium(self):
        contents = {
            "quandl_error": {
                "code": "QEPx05",
                "message": (
                    "You have attempted to view a premium database in "
    ...
    def test_non_standard_columns(self):
        contents = {
            "dataset": {
                ...
                "data": [
                    ["2019-06-18", 1344.55, 1341.35, 1073.22, 1070.67, 1201.89, 1198.09]
                ],
                "end_date": "2019-06-18",
                "frequency": "daily",
                "order": None,
