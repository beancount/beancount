__copyright__ = "Copyright (C) 2013-2020, 2023-2025  Martin Blais"
...
class TestAccount(unittest.TestCase):
    def test_is_valid(self):
        ...
        self.assertTrue(account.is_valid("资产:CN:微信零钱"))
        self.assertTrue(account.is_valid("资产:支付宝1234"))
        self.assertTrue(account.is_valid("资产:CN:5678中行"))
        self.assertTrue(account.is_valid("Assets:Активы"))
